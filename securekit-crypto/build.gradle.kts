...
android {
    namespace = "com.byan.securekit.crypto"
    compileSdk = 36
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "securekit-crypto"
                version = "1.0.0"

                pom {
                    name.set("SecureKit Crypto")
                    description.set("Enterprise-grade Android Security Library - Tink AEAD & Streaming AEAD Storage")
