...
android {
    namespace = "com.byan.securekit.core"
    compileSdk = 36
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "securekit-core"
                version = "1.0.0"

                pom {
                    name.set("SecureKit Core")
                    description.set("Enterprise-grade Android Security Library - Core Memory Safety Primitives")
